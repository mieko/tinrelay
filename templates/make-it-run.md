...
Tinrelay is a program written in the Crystal programming language. It uses libsodium for cryptography and SQLite for the repeater's small durable store. Check which of these are already present on this computer. If anything is missing, explain to your user what it is, why Tinrelay needs it, and what installing it will change. Ask permission before using the computer's ordinary trusted package mechanisms.
